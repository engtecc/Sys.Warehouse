					...
					<div class="col-md-12">
						<form action="" method="POST" id="formCliente" enctype="multipart/form-data"> 
							...
							<div class="row rowForm">
								...
								<div class="col-md-2">
									<input class="form-control form-control-sm" type="text" id="txtRG" name="txtRG" value="" required>
								</div>
							</div>
							<div class="row rowForm">
								<div class="col-md-3 lblAl">
							...
							<div class="row rowForm">
								...
								<div class="col-md-4">
									<input class="form-control form-control-sm" style="width:211px;" type="text" id="txtTelefone" name="txtTelefone" value="" required>
								</div>
								<div class="col-md-3 lblAl">
									<label>Data Nasc.: </label>
								</div>
								<div class="col-md-2">
									<input class="form-control form-control-sm" style="width:202px; height: 30px; margin-left: -16px;" type="date" id="dateNascimento" name="dateNascimento" value="" required>
								</div>
							</div>
							<div class="row rowForm">
								<div class="col-md-3 lblAl">
