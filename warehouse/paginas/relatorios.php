    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                <div class="container marketing text-center">
                    <div class="row cursor">
                        <div class="col-lg-4 espacamento">
                            <a class="selecionado dia text-opcoes" ><img class="rounded-circle" src="../imagens/dia.png" alt="Generic placeholder image" width="100" height="100"><h5>dia</h5></a>
                        </div>
                        <div class="col-lg-4 espacamento">
                            <a class="mes text-opcoes" ><img class="rounded-circle" src="../imagens/mes.png" alt="Generic placeholder image" width="100" height="100"><h5>mês</h5></a>
                        </div>
                        <div class="col-lg-4 espacamento">
                            <a class="ano text-opcoes"><img class="rounded-circle" src="../imagens/ano.png" alt="Generic placeholder image" width="100" height="100"><h5>ano</h5></a>
                        </div>
                ...
                <section id="sectionDia" style="display: none;">
                    <div class="row mt-5">
