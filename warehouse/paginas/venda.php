	...
	<nav class="navbar navbar-expand-md navbar-dark sticky-top bg-dark justify-content-between menu">
		...
		<div class="collapse navbar-collapse" id="navbarCollapse"> 
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item">
					<a class="nav-link formatacao active" href="venda.php">VENDAS<span class="sr-only">(current)</span></a>
				</li>
						...
						<form method="POST" id="formCli"> 
							...
							<div class="row rowForm rowTable">
								<div class="col-md-3 lblAl">
									<label style="font-weight: bold;">Produtos da Venda:</label>
								</div>
							...
							<div class="row rowForm" style="vertical-align: center;">
								...
								<div class="input-group mb-3 col-md-6">
									...
									<input class="form-control form-control-sm" style="width: 87%;"type="number" step="any" id="numTotal" value=<?php echo($_SESSION["valortotal"]) ?>>
