	...
	<div class="row">
		...
		<div class="col-md-10">
				...
				<?php
					require_once '../bd.php';
					$cpf = $_GET["cpf"];
					$sql = "SELECT * FROM cliente,pessoa,endereco where cliente.id_pessoa = pessoa.id_pessoa and cliente.id_endereco = endereco.id_endereco and pessoa.id_endereco = endereco.id_endereco and pessoa.cpf LIKE '%$cpf%' Order By nome ASC";
