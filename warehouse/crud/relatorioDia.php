...
$query = mysqli_query($conexao, "SELECT login,nome,valor_total,tipo FROM venda as v,cliente as c, funcionario as f, pessoa as p WHERE v.id_cliente = c.id_cliente and v.id_funcionario = f.id_funcionario and c.id_pessoa = p.id_pessoa and data_horario = '$data' ORDER by data_horario ASC");
...
if($num>0){
    ...
    echo "</tr>";
    echo "<td class='text-center' style='width:80%;' colspan='3'>VALOR TOTAL DO DIA:</td>";
